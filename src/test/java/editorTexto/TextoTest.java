...
import editorTexto.TextoComponente;
...
public class TextoTest {
    ...
    @Before
    public void ini() {
        H = CaracterFactory.getFactory().get('H');
        o = CaracterFactory.getFactory().get('o');
        l = CaracterFactory.getFactory().get('l');
        a = CaracterFactory.getFactory().get('a');
        pf = new Parrafo();
        pf.add(H);
        pf.add(o);
        pf.add(l);
    ...
    public void testCaracterFlyweight() {
        assertSame(H, CaracterFactory.getFactory().get('H'));
    }
